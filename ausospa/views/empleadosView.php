    ...
    public function listarEmpleados($empleados)
    {
        ...
        foreach ($empleados as $empleado) {
            ...
            echo '<td>
                ...
                <button class="border-2 border-red-500 hover:bg-red-500 p-2 rounded-sm" name="Dni" value=' . $empleado['Dni'] . '>Eliminar</button>
                </form>
                </td>';
            echo "</tr>";
        }
        ...
        echo '<main class="p-4 flex justify-center align-center gap-4">
            <form action="./dashboard.php?controller=Empleado&action=insertar" method="POST" class="flex flex-col gap-4 w-full max-w-md mx-auto p-4 bg-white shadow-lg rounded-lg">
                ...
                <div class="flex justify-center items-center gap-4">
                    <button class="w-[150px] h-[50px] mx-auto shadow-lg rounded-lg hover:bg-gray-100" type="submit"><a href="./dashboard.php?controller=Empleado&action=listar">Cancelar</a></button>
