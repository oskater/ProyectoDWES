...
class EmpleadoController{
    ...
    public function listar(){
        $empleados = json_decode(file_get_contents("http://localhost:8081/ProyectoDWES/aserviciospa/empleados/index.php"), true);
        $this->empleadoView->listarEmpleados($empleados);
    }

    public function insertar(){
        // URL de la API con parámetros correctamente codificados
        $api_url = 'http://localhost:8081/ProyectoDWES/aserviciospa/empleados/index.php?dni=' . urlencode($_POST["dni"]) . 
    ...
    {
        // URL de la API
        $api_url = 'http://localhost:8081/ProyectoDWES/aserviciospa/empleados/index.php?dni=' . $_POST["dni"];
